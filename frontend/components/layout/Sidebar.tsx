...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
 ...
 <div className="flex flex-col h-full bg-brand-primary text-white overflow-hidden shadow-2xl border-r border-slate-700/50 relative">
 ...
 <div>
 <h1 className="text-xl font-bold bg-brand-primary from-white text-brand-primary">{shortName}</h1>
 ...
 <button
 onClick={onClose}
 className="md:hidden p-2 text-gray-400 hover:text-brand-primary rounded-lg hover:bg-slate-100 transition-colors"
 >
 <X className="h-6 w-6" />
 </button>
 </div>

 <Separator className="bg-brand-primary from-transparent to-transparent flex-shrink-0 relative z-10" />

 {/* User Info Card - Enhanced */}
 <div className="px-4 pb-4 flex-shrink-0 relative z-10">
 <div
 className="bg-brand-primary /80 /80 backdrop-blur-sm rounded-2xl p-4 border shadow-xl hover:shadow-2xl transition-all duration-300 group"
 style={{
 ...
 <Link
 href="/user/profile"
 className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-bold text-gray-200 bg-brand-primary border border-slate-600 rounded-lg hover: hover: hover:border-blue-500/50 hover:text-brand-primary hover:shadow-lg transition-all transform hover:scale-105"
 >
 ...
 className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 text-xs font-bold text-white bg-brand-primary rounded-lg hover: hover: hover:shadow-lg hover:shadow-red-500/30 transition-all transform hover:scale-105"
 >
 ...
 <div className="h-px flex-1 bg-brand-primary to-transparent" />
 ...
 : 'text-gray-300 hover:bg-brand-primary hover: hover: hover:text-brand-primary hover:shadow-md hover:scale-[1.02]'
 ...
 <div className="absolute inset-0 bg-brand-primary from-transparent via-white/5 to-transparent -skew-x-12 group-hover:animate-shine" />
 </div>
 )}
 ...
 ? 'bg-white'
 : 'bg-brand-primary text-white ring-2 ring-red-400/30'
 }`}
 style={isActive ? {
