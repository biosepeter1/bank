...
export function Topbar({ onMenuClick }: TopbarProps) {
 ...
 return (
 <div className="h-16 bg-brand-primary from-white /30 /30 backdrop-blur-sm border-b border-gray-200/50 shadow-sm flex items-center justify-between px-4 md:px-6 relative overflow-hidden">
 {/* Subtle animated background gradient */}
 <div className="absolute inset-0 bg-brand-primary /5 /5 /5 animate-gradient" />
 ...
 <div className="h-10 w-10 rounded-xl bg-brand-primary flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow hidden sm:flex">
 <span className="text-xl">👋</span>
 </div>
 <div className="flex flex-col">
 <span className="text-xs font-medium text-gray-500 uppercase tracking-wide hidden sm:block">{greeting}</span>
 <h2 className="text-lg font-bold bg-brand-primary text-brand-primary leading-tight">
 {userName}
 </h2>
 </div>
 </div>
 ...
 variant="ghost"
 size="icon"
 className="relative h-10 w-10 rounded-xl hover:bg-brand-primary hover: hover: transition-all group"
 >
 {unreadCount > 0 ? (
 ...
 {unreadCount > 0 && (
 <Badge className="absolute -top-1 -right-1 h-5 min-w-[20px] px-1 flex items-center justify-center text-[10px] font-bold bg-brand-primary border-2 border-white shadow-lg animate-pulse">
 ...
 <div className="flex items-center justify-between p-4 bg-brand-primary border-b border-gray-200">
 <div className="flex items-center gap-2">
 <div className="h-8 w-8 rounded-lg bg-brand-primary flex items-center justify-center shadow-md">
 <Bell className="h-4 w-4 text-white" />
 </div>
 <h3 className="font-bold text-base bg-brand-primary text-brand-primary">Notifications</h3>
 {unreadCount > 0 && (
 ...
 <div className="hidden md:flex flex-col items-end px-4 py-2 rounded-xl bg-brand-primary border border-gray-200/50 shadow-sm">
