...
export function DarkHeroSlider() {
 ...
 size="lg"
 variant="outline"
 className="h-12 px-8 text-base font-semibold rounded-full border-white/30 text-white hover:bg-white hover:text-brand-text"
 >
 ...
 className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-slate-100 backdrop-blur-sm flex items-center justify-center text-white hover:bg-slate-100 transition-all disabled:opacity-50 border border-slate-200"
 ...
 onClick={nextSlide}
 disabled={isAnimating}
 className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-slate-100 backdrop-blur-sm flex items-center justify-center text-white hover:bg-slate-100 transition-all disabled:opacity-50 border border-slate-200"
