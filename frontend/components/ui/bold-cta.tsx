      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <p className="font-space-grotesk text-xl md:text-2xl text-white/40 mb-20 max-w-2xl mx-auto leading-tight font-medium">
            Open your private banking account in under 180 seconds.
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link href="/register">
              ...
              >
                ...
                <span className="relative z-10 font-space-grotesk text-xl font-black uppercase tracking-tight">Open Account</span>
