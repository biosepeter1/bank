...
export function TrustStrip() {
 return (
 <section className="bg-[#F5F3EE] py-8 sm:py-12 md:py-16 bg-white border-b border-slate-200">
 ...
 className="mt-8 sm:mt-12 md:mt-16 pt-6 sm:pt-8 md:pt-10 border-t border-slate-200"
 >
 ...
 <div className="text-sm text-brand-text/50 font-medium">{stat.label}</div>
 </motion.div>
 ))}
 </div>
 </motion.div>
