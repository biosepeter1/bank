                ...
                <div className="bg-[#111111] rounded-t-xl sm:rounded-t-[2rem] p-3 sm:p-6 text-white">
                    ...
                    <div className="flex gap-2 sm:gap-4">
                        <div className="flex-1 bg-slate-100 backdrop-blur rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                            <div className="text-[10px] sm:text-xs text-slate-500 font-medium">Income</div>
                            <div className="font-bold text-xs sm:text-base text-slate-900">+$4,200</div>
                        </div>
                        <div className="flex-1 bg-slate-100 backdrop-blur rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                            <div className="text-[10px] sm:text-xs text-slate-500 font-medium">Expenses</div>
                            <div className="font-bold text-xs sm:text-base text-slate-900">-$1,832</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-4 gap-1 sm:gap-3">
                        {['Send', 'Pay', 'Cards', 'More'].map((action, i) => (
                            <div key={action} className="bg-slate-50 rounded-lg sm:rounded-[2rem] p-1.5 sm:p-4 text-center">
                                ...
                                <div className="text-[9px] sm:text-xs font-semibold text-slate-900">{action}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-8">
                    ...
                    <div className="bg-white rounded-xl sm:rounded-[2.5rem] shadow-xl sm:shadow-2xl p-1.5 sm:p-3 transform sm:-rotate-6">
                        <div className="bg-[#111111] rounded-lg sm:rounded-[2rem] p-3 sm:p-6 text-white w-[100px] sm:w-48">
                            ...
                            <div className="bg-slate-100 rounded-lg sm:rounded-xl p-1.5 sm:p-3 text-center">
                                <div className="text-[10px] sm:text-sm font-bold text-slate-900">To: John Doe</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl sm:rounded-[2.5rem] shadow-xl sm:shadow-2xl p-1.5 sm:p-3 transform sm:rotate-6">
                        <div className="bg-green-500 rounded-lg sm:rounded-[2rem] p-3 sm:p-6 text-white w-[100px] sm:w-48">
                            ...
                            <div className="text-base sm:text-3xl font-black mb-1 sm:mb-4">+$500</div>
                            <div className="bg-slate-100 rounded-lg sm:rounded-xl p-1.5 sm:p-3 text-center">
                                <div className="text-[10px] sm:text-sm font-bold text-slate-900">✓ Done</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-4 sm:mt-8 bg-white/80 backdrop-blur rounded-xl sm:rounded-[2rem] shadow-xl p-2.5 sm:p-4 max-w-[220px] sm:max-w-xs mx-auto">
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs sm:text-sm text-slate-500 font-medium">Completed in 0.3s</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        return (
            <div className="relative bg-white/80 backdrop-blur-xl border-slate-200 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl border border-slate-200 p-3 sm:p-6 overflow-hidden w-full max-w-[260px] sm:max-w-none mx-auto">
                ...
                <div className="flex items-center justify-between mb-3 sm:mb-6">
                    <div>
                        <div className="text-[10px] sm:text-sm text-slate-500 font-medium mb-0.5 sm:mb-1">Savings Goal</div>
                        <div className="text-base sm:text-2xl font-black text-slate-900">Fixed Deposit Account</div>
                    </div>
                ...
                <div className="mb-3 sm:mb-6">
                    <div className="flex justify-between text-xs sm:text-sm mb-1 sm:mb-2">
                        ...
                        <span className="text-slate-500 font-medium">of $10,000</span>
                    </div>
                    ...
                    <div className="text-right text-[10px] sm:text-sm text-slate-500 font-medium mt-0.5 sm:mt-1">75% Complete</div>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-[10px] sm:text-sm text-slate-500 font-medium">Annual Yield</div>
                            </div>
                        </div>
                ...
                <div className="p-3 sm:p-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                        <div className="bg-slate-50 rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                            ...
                            <div className="text-[9px] sm:text-xs text-slate-500 font-medium">Invoices</div>
                        </div>
                        <div className="bg-green-50 rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                            ...
                            <div className="text-[9px] sm:text-xs text-slate-500 font-medium">Revenue</div>
                        </div>
                    </div>
                </div>
            </div>
