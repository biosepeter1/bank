...
const promoSlides: PromoSlide[] = [
 ...
 features: ["SAVE AT LEAST ₦50,000","GROW YOUR ACCOUNT BALANCE","COMPLETE 5 TRANSACTIONS ON ANY OF OUR DIGITAL CHANNELS"
 ],
 ...
 features: ["INVITE FRIENDS TO OPEN AN ACCOUNT","SHARE YOUR UNIQUE REFERRAL LINK","EARN ₦10,000 FOR EACH SUCCESSFUL REFERRAL"
 ],
 ctaText:"Refer Now",
 ctaLink:"/register",
 ...
 features: ["DOWNLOAD OUR MOBILE APP","INSTANT MONEY TRANSFERS","PAY BILLS & BUY AIRTIME EASILY"
 ],
 ctaText:"Get Started",
 ctaLink:"/register",
 ...
 features: ["OPEN A CORPORATE ACCOUNT","ACCESS PAYROLL SOLUTIONS","MERCHANT SERVICES AVAILABLE"
 ],
...
export function PromotionalHeroSlider() {
 ...
 {/* Prize board */}
 <div
 className="relative px-10 py-8 rounded-[2rem] shadow-2xl transform"
 style={{
 ...
 className="absolute left-2 md:left-6 lg:left-10 top-1/2 -translate-y-1/2 z-30 w-14 h-14 rounded-full bg-slate-100 backdrop-blur-md flex items-center justify-center text-white hover:bg-white/30 transition-all group border border-white/30 shadow-lg disabled:opacity-50"
 ...
 onClick={nextSlide}
 disabled={isAnimating}
 className="absolute right-2 md:right-6 lg:right-10 top-1/2 -translate-y-1/2 z-30 w-14 h-14 rounded-full bg-slate-100 backdrop-blur-md flex items-center justify-center text-white hover:bg-white/30 transition-all group border border-white/30 shadow-lg disabled:opacity-50"
 ...
 : 'w-4 h-4 bg-slate-500 hover:bg-white/70'
 }`}
