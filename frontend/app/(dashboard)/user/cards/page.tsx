  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-violet-50 to-purple-50">
      ...
      >
        ...
        <div
          className="relative overflow-hidden rounded-2xl sm:rounded-3xl text-white shadow-2xl"
          style={{
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-8 items-center">
              ...
              <div className="text-white">
                ...
                <motion.p
                  ...
                  className="text-white/90 mb-4 sm:mb-8 text-sm sm:text-base md:text-lg leading-relaxed line-clamp-3 sm:line-clamp-none"
                >
