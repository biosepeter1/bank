        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-white text-xs sm:text-sm font-medium">Enterprise Solutions</span>
            </motion.div>
            ...
            <div className="flex justify-center">
              <Link href="/register">
                <Button size="lg" className="h-11 sm:h-12 md:h-14 px-5 sm:px-6 md:px-8 bg-white text-brand-primary hover:bg-white/90 text-sm sm:text-base md:text-lg font-bold shadow-xl">
